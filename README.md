...
- `date`
    ...
    date of creation of document (e.g `\DTMdate{2018-03-25}`)

- `last_revised_date`
    
    last revision of the document (e.g `\DTMtoday`)

- `document_type`
    
    type of document (e.g meeting minutes, specs, post-mortem...)

- `document_classification_level`
    
    classification level of the document (e.g. secret, confidential, restricted...)
...
- `document_logo_path`
    ...
    path to the logo for the title page
